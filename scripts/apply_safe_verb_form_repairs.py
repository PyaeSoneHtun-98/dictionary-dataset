...
MANUAL_FORMS: dict[str, list[str]] = {
    ...
    "doss": ["dosses", "dossed", "dossing"],
    "suntan": ["suntans", "suntanned", "suntanning"],
    "sashay": ["sashays", "sashayed", "sashaying"],
    "clop": ["clops", "clopped", "clopping"],
    "plonk": ["plonks", "plonked", "plonking"],
    "gawp": ["gawps", "gawped", "gawping"],
    "mewl": ["mewls", "mewled", "mewling"],
    "razz": ["razzes", "razzed", "razzing"],
    "scry": ["scries", "scried", "scrying"],
    "busk": ["busks", "busked", "busking"],
    "glom": ["gloms", "glommed", "glomming"],
    "drub": ["drubs", "drubbed", "drubbing"],
    "flub": ["flubs", "flubbed", "flubbing"],
    "cosh": ["coshes", "coshed", "coshing"],
    "pule": ["pules", "puled", "puling"],
    "stet": ["stets", "stetted", "stetting"],
    "birl": ["birls", "birled", "birling"],
    "birr": ["birrs", "birred", "birring"],
    "bitt": ["bitts", "bitted", "bitting"],
    "blat": ["blats", "blatted", "blatting"],
    "blub": ["blubs", "blubbed", "blubbing"],
    "cark": ["carks", "carked", "carking"],
    "moil": ["moils", "moiled", "moiling"],
    "plat": ["plats", "platted", "platting"],
    "pock": ["pocks", "pocked", "pocking"],
    "rase": ["rases", "rased", "rasing"],
    "seel": ["seels", "seeled", "seeling"],
    "siss": ["sisses", "sissed", "sissing"],
    "sizz": ["sizzes", "sizzed", "sizzing"],
    "sorb": ["sorbs", "sorbed", "sorbing"],
    "babbitt": ["babbitts", "babbitted", "babbitting"],
    "citrate": ["citrates", "citrated", "citrating"],
    "chicane": ["chicanes", "chicaned", "chicaning"],
    "quickstep": ["quicksteps", "quickstepped", "quickstepping"],
    "palaver": ["palavers", "palavered", "palavering"],
    "environ": ["environs", "environed", "environing"],
    "recurve": ["recurves", "recurved", "recurving"],
    "backscatter": ["backscatters", "backscattered", "backscattering"],
    "prang": ["prangs", "pranged", "pranging"],
    "silkscreen": ["silkscreens", "silkscreened", "silkscreening"],
    "drydock": ["drydocks", "drydocked", "drydocking"],
    "carboxylate": ["carboxylates", "carboxylated", "carboxylating"],
    "yawl": ["yawls", "yawled", "yawling"],
    "kibosh": ["kiboshes", "kiboshed", "kiboshing"],
    "whish": ["whishes", "whished", "whishing"],
    "shinny": ["shinnies", "shinnied", "shinnying"],
}
